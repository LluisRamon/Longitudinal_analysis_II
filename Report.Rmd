...
* Let $H_{ij} = {Y_{i1}, Y_{i2}, \ldots , Y_{i,j−1}} =$ history of past responses.
...
xtaula <- xtable(cbind(Beta1=a, t(taula)), caption="Odds ratio and 95% confidence interval, given the coefficient for the PCV.", label="catpcv")
print(xtaula, comment=F, include.rownames=F)
```
