...
Table \ref{tab:classifcation_GEE} shows the classification table for the chosen model. The selected model has a sensitivity of 0.911 and a specificity of 0.839.
...
xtaula <- xtable(xx, caption="Crosstable with the predicted data with the model and the original data.", label="tab:classifcation_GEE")
print(xtaula)
```
