...
is dropped out from the study due to having too many health issues. This makes
sense also when looking at Figure ????: the cow with ID 5, for example, would 
...
this explains the missings for the medium dose, having, under this assumption, 
a monotone pattern of missing data. In this sense, our sample could be easily 
