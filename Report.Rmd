...
It appaers that an increase of unit in time increases the odds ratio by XXXXXXX which means that it is xxxxxxxxxx times more likely to be healthy than unhealthy. The random effect son the time add variability to the effect of time depending on the id and on the dose. Table XX gives the interval in which the values lie.
