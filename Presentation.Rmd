...
\begin{tabular}{rrrrr}
 ...
 & AIC & p-value \\ 
  \hline
$\beta_{0} + (\beta_{1} + b_{1i})time + \beta_2 doseM + \beta_3 doseH$ & 36.592  &  \\ 
 $\beta_{0} + (\beta_{1} + b_{1i})time + \beta_2 doseM + \beta_3 doseH + \beta_4 nbirth$ & 38.335 & 0.6123 \\ 
 $\beta_{0} + (\beta_{1} + b_{1i})time + \beta_2 doseM + \beta_3 doseH + \beta_4 dose*time$ & 38.998 & 0.4506 \\  
   \hline
\end{tabular}
\end{table}
\normalsize
